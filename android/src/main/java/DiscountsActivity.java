...
public class DiscountsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!isConnected(DiscountsActivity.this)) {
            buildDialog(DiscountsActivity.this).show();
            return;
        }
        else {
    ...
    public void findStores(){
        String url = "http://188.226.144.157/group1/find_allstores.php";
        ...
        JsonArrayRequest jsonArrRequest = new JsonArrayRequest(Request.Method.POST, url, jsonArr, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response1) {
                ...
                {
                    Log.i("NAWAWY MSH TMAM MN TA7T","SA7?");
                }
            }
    ...
    private void fillList(final JSONArray resp,final int i) throws JSONException {
        indexMap.add(i);
        String url = "http://188.226.144.157/group1/find_store_data.php";
        if ( requestQueue == null )
        requestQueue = Volley.newRequestQueue(getApplicationContext());
